...
<cffunction name="renderChain" access="public" output="false" returntype="string">
	...
	<cfif isNull(variables.cache_basket) OR site_config.useCache EQ false OR true EQ false>
...
<!---
	<cfdump var="#arguments.filterlist#">
	<cfdump var="#variables.cache_basket.codes.codes#">
	<cfabort>
--->
...
<!---
		    <cfdump var="#variables.shortCodesObjectl.getCodeCache()#">
		    <cfabort> --->
		</cfif>
	</cfif>
...
<cffunction name="filterGetShortCodes" access="private" output="false" returntype="void">
	<cfset var c = "">
	...
	<cfset variables.cache_basket.codes = c>
</cffunction>
