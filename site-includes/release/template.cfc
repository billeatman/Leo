...
<cffunction name="init" returntype="void" access="public" output="false">
	...
	<cfargument name="site_context" type="struct" required="false">
	...
	<cfif NOT isNull(arguments.site_context)>
		<cfif lcase(arguments.site_context.sitename) NEQ lcase(arguments.site_config.CMS.sitename)>
			<cfset variables.context = arguments.site_context>
			<cfset variables.isSiteContext = false>
			<cfset variables.basepath = arguments.site_context.basepath>
		</cfif>
	</cfif>
...
<cffunction name="useTemplateContext" access="public" output="true">
...
<cffunction name="useSiteContext" access="public" output="true">
...
<cffunction name="createWidget" access="public" returntype="ANY" output="false">
	...
	<cfreturn createObject("widgets.#widgetname#").init(argumentCollection: arguments, head_code: variables.shortCodesObject.getHeadCode(), site_config: variables.sc)>
</cffunction>
